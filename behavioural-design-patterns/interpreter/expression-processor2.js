...
ep.variables['x'] = 5;
console.log(ep.calculate('1+2')); //.toEqual(3);
console.log(ep.calculate('1')); //.toEqual(1);
console.log(ep.calculate('1+2')); //.toEqual(3);
console.log(ep.calculate('1+x')); //.toEqual(6);
console.log(ep.calculate('1+xy')); //.toEqual(0);
